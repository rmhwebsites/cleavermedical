...
(function () {
  ...
  var IC = {
    ...
    contouring: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M8 4c-2 3-3 6-3 8s1 5 3 8"/><path d="M16 4c2 3 3 6 3 8s-1 5-3 8"/><path d="M5 12h3M16 12h3"/><path d="M5 11l3 1-3 1"/><path d="M19 11l-3 1 3 1"/></svg>',
    double_chin: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M16 3c2 0 3.5 1.5 3.5 4s-1.5 4-3.5 5l-2 1.5"/><path d="M14 13.5c-1.5 1-3 1.5-4.5 1-2-.5-3-2-3-4"/><path d="M13 16c-1 2.5-1 4 0 5" opacity=".5"/><circle cx="17" cy="6" r=".5" fill="currentColor" stroke="none"/></svg>',
